...
namespace Business.Constants
{
    public class Messages
    {
        ...
        public static string CarImageAdded = "Resim Başaralı Şekilde Eklnedi";
        public static string CarImageDeleted = "Resim Başarılı Şekilde Silindi";
        public static string CarImageLimit = "Resim Ekleme Sınırına Ulaşıldı 5'ten Fazla Resim Ekliyemezsiniz";
        public static string CarImageUpdated = "Resim Başarılı Şekilde Güncellendi";
